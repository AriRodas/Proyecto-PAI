...
from routes.paquetes_routes import PaquetesROutes
from routes.checkout_routes import checkoutRoutes
...
PaquetesROutes.configure_routes(app)
checkoutRoutes.configure_routes(app)
